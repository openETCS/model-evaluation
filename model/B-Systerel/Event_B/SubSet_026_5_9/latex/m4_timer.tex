...
\VARIABLES
        \begin{description}
                ...
                \Item{ currently\_asking\_driver\_brake\_ack }
                \ItemY{ driver\_responded\_brake\_ack }{}
                \ItemY{ timer\_expired }{}
        \end{description}
\INVARIANTS
        \begin{description}
                \nItem{ inv1 }{ timer\_expired \in  BOOL }
        \end{description}
\EVENTS
        \INITIALISATION
                \\\textit{extended}\cmt{ }
                ...
                \BeginAct
                        ...
                        \nItemXY{ init\_deactivated\_brake }{ deactivated\_brake :=  FALSE }{  }
