...
\EVENTS
        ...
        \EXTD {initiate\_session\_after\_contact}
                ...
                \EndAct
                \end{description}
        \EVT {initiate\_session\_no\_contact\_SOM}\cmt{}
        \EXTD {initiate\_session\_no\_contact\_SOM}
                \begin{description}
                \AnyPrm
                        \begin{description}
                        \ItemXY{l\_partner }{ }
                ...
                \EndAct
                \end{description}
        \EVT {initiate\_session\_no\_contact\_status\_change}
        \EXTD {initiate\_session\_no\_contact\_status\_change}
                \begin{description}
                \AnyPrm
                        \begin{description}
                        \ItemXY{l\_partner }{ }
                ...
                \WhereGrd
                        ...
                        \nItemXY{ grd7 }{ signal\_status\_change = TRUE }{ }
                ...
                \ThenAct
                        \begin{description}
                        \nItemXY{ act2 }{ contacted :=  contacted \bunion  \{ l\_partner\}  }{  }
                        \nItemX{ act3 }{ signal\_status\_change :=  FALSE }
                        \nItem{ act4 }{ establish\_ER\_connection :=  establish\_ER\_connection \bunion  \{ l\_partner\}  }
                        \end{description}
                \EndAct
                \end{description}
        \EVT {initiate\_session\_no\_contact\_manual\_change}
        \EXTD {initiate\_session\_no\_contact\_manual\_change}
                \begin{description}
                \AnyPrm
                        \begin{description}
                        \ItemXY{l\_partner }{ }
                ...
                \EndAct
                \end{description}
        \EVT {initiate\_session\_no\_contact\_leave\_radio\_hole}
        \EXTD {initiate\_session\_no\_contact\_leave\_radio\_hole}
                \begin{description}
                \AnyPrm
                        \begin{description}
                        \ItemXY{l\_partner }{ }
                ...
                \EndAct
                \end{description}
        \EVT {initiate\_session\_after\_timeout}
