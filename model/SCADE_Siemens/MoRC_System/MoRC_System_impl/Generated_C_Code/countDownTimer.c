...
void countDownTimer_reset(outC_countDownTimer *outC)
{
  outC->init = kcg_true;
  outC->init1 = kcg_true;
}
  ...
  outC_countDownTimer *outC)
{
  ...
  /* countDownTimer::TimerStatus_SM */ SSM_ST_TimerStatus_SM TimerStatus_SM_state_sel;
  /* countDownTimer::TimerStatus_SM */ SSM_ST_TimerStatus_SM TimerStatus_SM_state_act;
