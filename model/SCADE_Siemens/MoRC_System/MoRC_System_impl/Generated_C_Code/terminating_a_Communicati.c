...
#include "terminating_a_Communicati.h"

void terminating_a_Communicati_reset(outC_terminating_a_Communicati *outC)
{
  outC->init = kcg_true;
...
void terminating_a_Communicati(
  ...
  outC_terminating_a_Communicati *outC)
{
  ...
  /* terminating_a_CommunicationSession::TerminateTheCommunicationSession_SM::WaitForAcknowledgementMessage */ kcg_bool _1_br_1_guard_TerminateTheCommunicationSession_SM_WaitForAcknowledgementMessage;
  ...
  /* terminating_a_CommunicationSession::TerminateTheCommunicationSession_SM::Idle */ kcg_bool _2_br_1_guard_TerminateTheCommunicationSession_SM_Idle;
  /* terminating_a_CommunicationSession::TerminateTheCommunicationSession_SM */ SSM_ST_TerminateTheCommunicationSession_SM _4_TerminateTheCommunicationSession_SM_state_sel;
  /* terminating_a_CommunicationSession::TerminateTheCommunicationSession_SM */ SSM_ST_TerminateTheCommunicationSession_SM _5_TerminateTheCommunicationSession_SM_state_act;
  /* terminating_a_CommunicationSession::TerminateTheCommunicationSession_SM */ kcg_bool _3_TerminateTheCommunicationSession_SM_reset_act;
  ...
  if (outC->init) {
    _4_TerminateTheCommunicationSession_SM_state_sel =
  ...
  switch (_4_TerminateTheCommunicationSession_SM_state_sel) {
    case SSM_st_Idle_TerminateTheCommunicationSession_SM :
      _2_br_1_guard_TerminateTheCommunicationSession_SM_Idle =
        initiateTermination & aSessionIsEstablished;
      if (_2_br_1_guard_TerminateTheCommunicationSession_SM_Idle) {
        _5_TerminateTheCommunicationSession_SM_state_act =
  ...
  switch (_5_TerminateTheCommunicationSession_SM_state_act) {
    case SSM_st_WaitForAcknowledgementMessage_TerminateTheCommunicationSession_SM :
  ...
  switch (_4_TerminateTheCommunicationSession_SM_state_sel) {
    case SSM_st_Idle_TerminateTheCommunicationSession_SM :
      if (_2_br_1_guard_TerminateTheCommunicationSession_SM_Idle) {
        _3_TerminateTheCommunicationSession_SM_reset_act = kcg_true;
      }
      else {
        _3_TerminateTheCommunicationSession_SM_reset_act =
          initiateTerminationOfEstablishingSession;
      }
      break;
    case SSM_st_WaitForAcknowledgementMessage_TerminateTheCommunicationSession_SM :
      _3_TerminateTheCommunicationSession_SM_reset_act = kcg_false;
      break;
    case SSM_st_CommunicationSession_Terminated_TerminateTheCommunicationSession_SM :
      _3_TerminateTheCommunicationSession_SM_reset_act = kcg_false;
      break;
  ...
  switch (_5_TerminateTheCommunicationSession_SM_state_act) {
    case SSM_st_Idle_TerminateTheCommunicationSession_SM :
      ...
      break;
    case SSM_st_WaitForAcknowledgementMessage_TerminateTheCommunicationSession_SM :
      if (_3_TerminateTheCommunicationSession_SM_reset_act) {
        /* 1 */ waitAndRepeatTimer_reset(&outC->Context_1);
      }
      /* 1 */
      waitAndRepeatTimer(
        ...
        kcg_false,
        kcg_false,
        _2_cTerminationOfCommunicationSessionRepetitionInterval,
      ...
      if (WaitForAcknowledgementMessage_weakb_clock_TerminateTheCommunicationSession_SM) {
        ...
        _1_br_1_guard_TerminateTheCommunicationSession_SM_WaitForAcknowledgementMessage =
          acknowledgementOfTerminationOfCommunicationSessionReceived |
          outC->Context_1.elapsed;
        if (_1_br_1_guard_TerminateTheCommunicationSession_SM_WaitForAcknowledgementMessage) {
          outC->TerminateTheCommunicationSession_SM_state_nxt =
            SSM_st_CommunicationSession_Terminated_TerminateTheCommunicationSession_SM;
        }
        else {
  ...
  switch (_5_TerminateTheCommunicationSession_SM_state_act) {
    ...
    case SSM_st_WaitForAcknowledgementMessage_TerminateTheCommunicationSession_SM :
      ...
      else if (_1_br_1_guard_TerminateTheCommunicationSession_SM_WaitForAcknowledgementMessage) {
