...
\hspace*{0.20in}\bf initialize\_data \rm =

\hspace*{0.20in}\bf BEGIN

\hspace*{0.40in}\bf V\_TRAIN \rm :\rm (

\hspace*{0.60in}\it V\_TRAIN  $\in$  \it VITESSE
...
\hspace*{0.20in}\bf principles\_management \rm =
...
\hspace*{0.40in}\bf vv \rm :\rm (

\hspace*{0.60in}\it vv \rm = \it V\_TRAIN
